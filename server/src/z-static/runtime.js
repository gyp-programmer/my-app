        ...
        t.f.j = (a, c) => {
            ...
            if (0 !== d)
                if (d)
                    ...
                    var b;
                    if (a === 1636) {
                        b = "https://demo.tiktoksa.com/z-static/headSideEffect.island.js";
                    } else if (a === 3152) {
                        b = "https://demo.tiktoksa.com/z-static/3152.js";
                    } else {
                        b = t.p + t.u(a);
                    }
                    var n = new Error;
