    ...
    if (sandbox) {
      if (!window.Proxy) {
        ...
        return _objectSpread(
          _objectSpread({}, configuration),
          {},
          {
            sandbox:
              _typeof(sandbox) === "object"
                ? _objectSpread(
                    _objectSpread({}, sandbox),
                    {},
                    {
                      loose: true,
                    },
      ...
      if (
        !isConstDestructAssignmentSupported() &&
        (sandbox === true ||
          (_typeof(sandbox) === "object" && sandbox.speedy !== false))
      ) {
        console.warn(
...
export function registerMicroApps(apps, lifeCycles) {
  ...
  microApps = [].concat(
    _toConsumableArray(microApps),
    _toConsumableArray(unregisteredApps),
  );
              ...
              while (1)
                switch ((_context3.prev = _context3.next)) {
                  ...
                  case 5:
                    ...
                    otherMicroAppConfigs = _objectWithoutProperties(
                      _yield$loadApp,
                      _excluded2,
                    );
...
export function loadMicroApp(app, configuration, lifeCycles) {
                  ...
                  while (1)
                    switch ((_context4.prev = _context4.next)) {
                      case 0:
                        ...
                        prevLoadMicroAppsWhichNotBroken =
                          prevLoadMicroApps.filter(function (v) {
                            return (
        ...
        return _regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1)
            switch ((_context5.prev = _context5.next)) {
              case 0:
                userConfiguration = autoDowngradeForLowVersionBrowser(
                  configuration !== null && configuration !== void 0
                    ? configuration
                    : _objectSpread(
                        _objectSpread({}, frameworkConfiguration),
                        {},
                        {
                          singular: false,
                        },
                ...
                $$cacheLifecycleByAppName =
                  userConfiguration.$$cacheLifecycleByAppName;
                if (!container) {
                  _context5.next = 21;
                  break;
                }
              ...
              case 21:
                parcelConfigObjectGetterPromise = loadApp(
                  app,
                  userConfiguration,
                  lifeCycles,
                );
  ...
  if (
    ...
    startSingleSpa({
      urlRerouteOnly:
        (_frameworkConfigurati = frameworkConfiguration.urlRerouteOnly) !==
          null && _frameworkConfigurati !== void 0
          ? _frameworkConfigurati
...
export function start() {
  ...
  var _frameworkConfigurati2 = frameworkConfiguration,
    ...
    urlRerouteOnly =
      _frameworkConfigurati3 === void 0
        ? defaultUrlRerouteOnly
        : _frameworkConfigurati3,
    importEntryOpts = _objectWithoutProperties(
      _frameworkConfigurati2,
      _excluded3,
    );
  if (prefetch) {
